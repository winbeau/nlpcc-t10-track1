...
| s51 | m | **full-traindev λ-ablation softmin**:softmin @ s33 同数据(`data/full_grid`)/同配置/同 4214 步,唯一改 λ=0.5;**vs s33(plainCE 42.87)定 softmin 在 full-traindev 有没有用** | `testp1_s51_m_ablate-softmin-full` | **待Codabench** | — | — | 242 (82/122/20/18) |
